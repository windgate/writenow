...
function $e8f09a94a9b12d55$var$SubmenuTrigger(props) {
    ...
    if (isMobile) {
        ...
        if (trayContainerRef.current && submenuTriggerState.isOpen) overlay = /*#__PURE__*/ (0, ($parcel$interopDefault($8ibdT$reactdom))).createPortal(menu, trayContainerRef.current);
    } else {
