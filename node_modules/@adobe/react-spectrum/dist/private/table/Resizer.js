...
import $3A0G8$intlStringsjs from "./intlStrings.js";
import "../table_vars.css";
import $3A0G8$table_vars_cssmjs from "../table_vars_css.mjs";
import {useTableContext as $0f1ea4f28e10f05a$export$3cb274deb6c2d854, useVirtualizerContext as $0f1ea4f28e10f05a$export$3f8f74b6bfd2c5df} from "./TableViewBase.js";
import {FocusRing as $3A0G8$FocusRing} from "react-aria/FocusRing";
import {isWebKit as $3A0G8$isWebKit} from "react-aria/private/utils/platform";
import {mergeProps as $3A0G8$mergeProps} from "react-aria/mergeProps";
import $3A0G8$react, {createContext as $3A0G8$createContext, useContext as $3A0G8$useContext, useState as $3A0G8$useState, useEffect as $3A0G8$useEffect} from "react";
import $3A0G8$reactdom from "react-dom";
import {useLocale as $3A0G8$useLocale} from "react-aria/I18nProvider";
import {useLocalizedStringFormatter as $3A0G8$useLocalizedStringFormatter} from "react-aria/useLocalizedStringFormatter";
import {useObjectRef as $3A0G8$useObjectRef} from "react-aria/useObjectRef";
import {useTableColumnResize as $3A0G8$useTableColumnResize} from "react-aria/useTable";
import {useUNSAFE_PortalContext as $3A0G8$useUNSAFE_PortalContext} from "react-aria/PortalProvider";
...
function $78389b17485c731f$var$getCursor(svg, fallback) {
    ...
    if ((0, $3A0G8$isWebKit)()) return `image-set(url("data:image/svg+xml,${encodeURIComponent(svg)}") 1x, url("data:image/svg+xml,${encodeURIComponent(svg.replace('width="32" height="32"', 'width="64" height="64"'))}") 2x) 8 8, ${fallback}`;
    else return `url("data:image/svg+xml,${encodeURIComponent(svg)}") 8 8, ${fallback}`;
}
const $78389b17485c731f$var$CURSORS = {
    ew: $78389b17485c731f$var$getCursor((0, (/*@__PURE__*/$parcel$interopDefault($c4c4277a4ce73438$exports))), 'ew-resize'),
    w: $78389b17485c731f$var$getCursor((0, (/*@__PURE__*/$parcel$interopDefault($c017aaf06aab7344$exports))), 'w-resize'),
    e: $78389b17485c731f$var$getCursor((0, (/*@__PURE__*/$parcel$interopDefault($eec3e03816de9459$exports))), 'e-resize')
};
const $78389b17485c731f$export$b517d84d4ad20b24 = /*#__PURE__*/ (0, $3A0G8$createContext)(null);
const $78389b17485c731f$export$48a76196cafe3b93 = /*#__PURE__*/ (0, $3A0G8$react).forwardRef(function Resizer(props, ref) {
    let { column: column, showResizer: showResizer } = props;
    let objectRef = (0, $3A0G8$useObjectRef)(ref);
    let { isEmpty: isEmpty, onFocusedResizer: onFocusedResizer } = (0, $0f1ea4f28e10f05a$export$3cb274deb6c2d854)();
    let layout = (0, $3A0G8$useContext)($78389b17485c731f$export$b517d84d4ad20b24);
    ...
    (0, $0f1ea4f28e10f05a$export$3f8f74b6bfd2c5df)();
    let stringFormatter = (0, $3A0G8$useLocalizedStringFormatter)((0, ($parcel$interopDefault($3A0G8$intlStringsjs))), '@react-spectrum/table');
    let { direction: direction } = (0, $3A0G8$useLocale)();
    let [isPointerDown, setIsPointerDown] = (0, $3A0G8$useState)(false);
    (0, $3A0G8$useEffect)(()=>{
        let setDown = (e)=>{
    ...
    let { inputProps: inputProps, resizerProps: resizerProps } = (0, $3A0G8$useTableColumnResize)((0, $3A0G8$mergeProps)(props, {
    ...
    let cursor = '';
    if (isEResizable) cursor = direction === 'rtl' ? $78389b17485c731f$var$CURSORS.w : $78389b17485c731f$var$CURSORS.e;
    else if (isWResizable) cursor = direction === 'rtl' ? $78389b17485c731f$var$CURSORS.e : $78389b17485c731f$var$CURSORS.w;
    else cursor = $78389b17485c731f$var$CURSORS.ew;
    let style = {
        ...resizerProps.style,
        height: '100%',
    ...
    return /*#__PURE__*/ (0, $3A0G8$react).createElement((0, $3A0G8$react).Fragment, null, /*#__PURE__*/ (0, $3A0G8$react).createElement((0, $3A0G8$FocusRing), {
        within: true,
        focusRingClass: (0, $512ba93e663f149c$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($3A0G8$table_vars_cssmjs))), 'focus-ring')
    }, /*#__PURE__*/ (0, $3A0G8$react).createElement("div", {
        ...resizerProps,
        role: "presentation",
        style: style,
        className: (0, $512ba93e663f149c$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($3A0G8$table_vars_cssmjs))), 'spectrum-Table-columnResizer')
    }, /*#__PURE__*/ (0, $3A0G8$react).createElement("input", {
        ref: objectRef,
        ...(0, $3A0G8$mergeProps)(inputProps, {
            onFocus: onFocusedResizer
        })
    }))), /*#__PURE__*/ (0, $3A0G8$react).createElement("div", {
        "aria-hidden": true,
        role: "presentation",
        className: (0, $512ba93e663f149c$export$ce4ab0c55987d1ff)((0, ($parcel$interopDefault($3A0G8$table_vars_cssmjs))), 'spectrum-Table-columnResizerPlaceholder')
    }), /*#__PURE__*/ (0, $3A0G8$react).createElement($78389b17485c731f$var$CursorOverlay, {
...
function $78389b17485c731f$var$CursorOverlay(props) {
    let { show: show, children: children } = props;
    let { getContainer: getContainer } = (0, $3A0G8$useUNSAFE_PortalContext)();
    var _getContainer;
    return show ? /*#__PURE__*/ (0, $3A0G8$reactdom).createPortal(children, (_getContainer = getContainer === null || getContainer === void 0 ? void 0 : getContainer()) !== null && _getContainer !== void 0 ? _getContainer : document.body) : null;
}


export {$78389b17485c731f$export$b517d84d4ad20b24 as ResizeStateContext, $78389b17485c731f$export$48a76196cafe3b93 as Resizer};
