...
var $hKSPM$reactariaFocusRing = require("react-aria/FocusRing");
var $hKSPM$reactariaprivateutilsplatform = require("react-aria/private/utils/platform");
var $hKSPM$reactariamergeProps = require("react-aria/mergeProps");
var $hKSPM$react = require("react");
var $hKSPM$reactdom = require("react-dom");
var $hKSPM$reactariaI18nProvider = require("react-aria/I18nProvider");
var $hKSPM$reactariauseLocalizedStringFormatter = require("react-aria/useLocalizedStringFormatter");
var $hKSPM$reactariauseObjectRef = require("react-aria/useObjectRef");
var $hKSPM$reactariauseTable = require("react-aria/useTable");
var $hKSPM$reactariaPortalProvider = require("react-aria/PortalProvider");
...
function $09b5aa08c9e8cf9f$var$getCursor(svg, fallback) {
    ...
    if ((0, $hKSPM$reactariaprivateutilsplatform.isWebKit)()) return `image-set(url("data:image/svg+xml,${encodeURIComponent(svg)}") 1x, url("data:image/svg+xml,${encodeURIComponent(svg.replace('width="32" height="32"', 'width="64" height="64"'))}") 2x) 8 8, ${fallback}`;
    else return `url("data:image/svg+xml,${encodeURIComponent(svg)}") 8 8, ${fallback}`;
}
const $09b5aa08c9e8cf9f$var$CURSORS = {
    ew: $09b5aa08c9e8cf9f$var$getCursor((0, (/*@__PURE__*/$parcel$interopDefault($caf3dd6e64b98ac9$exports))), 'ew-resize'),
    w: $09b5aa08c9e8cf9f$var$getCursor((0, (/*@__PURE__*/$parcel$interopDefault($d56c5d1f738fc8f0$exports))), 'w-resize'),
    e: $09b5aa08c9e8cf9f$var$getCursor((0, (/*@__PURE__*/$parcel$interopDefault($2e1bea52a4aed244$exports))), 'e-resize')
};
const $09b5aa08c9e8cf9f$export$b517d84d4ad20b24 = /*#__PURE__*/ (0, $hKSPM$react.createContext)(null);
const $09b5aa08c9e8cf9f$export$48a76196cafe3b93 = /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).forwardRef(function Resizer(props, ref) {
    let { column: column, showResizer: showResizer } = props;
    let objectRef = (0, $hKSPM$reactariauseObjectRef.useObjectRef)(ref);
    let { isEmpty: isEmpty, onFocusedResizer: onFocusedResizer } = (0, $783600b7b364e0bf$exports.useTableContext)();
    let layout = (0, $hKSPM$react.useContext)($09b5aa08c9e8cf9f$export$b517d84d4ad20b24);
    ...
    (0, $783600b7b364e0bf$exports.useVirtualizerContext)();
    let stringFormatter = (0, $hKSPM$reactariauseLocalizedStringFormatter.useLocalizedStringFormatter)((0, ($parcel$interopDefault($12f8715bf7a5f0e7$exports))), '@react-spectrum/table');
    let { direction: direction } = (0, $hKSPM$reactariaI18nProvider.useLocale)();
    let [isPointerDown, setIsPointerDown] = (0, $hKSPM$react.useState)(false);
    (0, $hKSPM$react.useEffect)(()=>{
        let setDown = (e)=>{
    ...
    let { inputProps: inputProps, resizerProps: resizerProps } = (0, $hKSPM$reactariauseTable.useTableColumnResize)((0, $hKSPM$reactariamergeProps.mergeProps)(props, {
    ...
    let cursor = '';
    if (isEResizable) cursor = direction === 'rtl' ? $09b5aa08c9e8cf9f$var$CURSORS.w : $09b5aa08c9e8cf9f$var$CURSORS.e;
    else if (isWResizable) cursor = direction === 'rtl' ? $09b5aa08c9e8cf9f$var$CURSORS.e : $09b5aa08c9e8cf9f$var$CURSORS.w;
    else cursor = $09b5aa08c9e8cf9f$var$CURSORS.ew;
    let style = {
        ...resizerProps.style,
        height: '100%',
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).createElement((0, ($parcel$interopDefault($hKSPM$react))).Fragment, null, /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).createElement((0, $hKSPM$reactariaFocusRing.FocusRing), {
        within: true,
        focusRingClass: (0, $69fd630bd812ba47$exports.classNames)((0, ($parcel$interopDefault($149bebff1c2de463$exports))), 'focus-ring')
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).createElement("div", {
        ...resizerProps,
        role: "presentation",
        style: style,
        className: (0, $69fd630bd812ba47$exports.classNames)((0, ($parcel$interopDefault($149bebff1c2de463$exports))), 'spectrum-Table-columnResizer')
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).createElement("input", {
        ref: objectRef,
        ...(0, $hKSPM$reactariamergeProps.mergeProps)(inputProps, {
            onFocus: onFocusedResizer
        })
    }))), /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).createElement("div", {
        "aria-hidden": true,
        role: "presentation",
        className: (0, $69fd630bd812ba47$exports.classNames)((0, ($parcel$interopDefault($149bebff1c2de463$exports))), 'spectrum-Table-columnResizerPlaceholder')
    }), /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$react))).createElement($09b5aa08c9e8cf9f$var$CursorOverlay, {
...
function $09b5aa08c9e8cf9f$var$CursorOverlay(props) {
    let { show: show, children: children } = props;
    let { getContainer: getContainer } = (0, $hKSPM$reactariaPortalProvider.useUNSAFE_PortalContext)();
    return show ? /*#__PURE__*/ (0, ($parcel$interopDefault($hKSPM$reactdom))).createPortal(children, getContainer?.() ?? document.body) : null;
}
