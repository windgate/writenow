 ...
 */
export declare const TreeSection: <T extends unknown>(props: GridListSectionProps<T> & React.RefAttributes<HTMLDivElement>) => React.ReactElement<unknown, string | React.JSXElementConstructor<any>> | null;
export declare const TreeHeader: (props: GridListHeaderProps) => ReactNode;
