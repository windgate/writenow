...
const $fd02a37bc042f4f4$var$LayoutContext = /*#__PURE__*/ (0, $68boB$react.createContext)(null);
function $fd02a37bc042f4f4$export$89be5a243e59c4b2(props) {
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($68boB$react))).createElement((0, $f7b82bedbb70abac$exports.CollectionRendererContext).Provider, {
        value: renderer
    }, /*#__PURE__*/ (0, ($parcel$interopDefault($68boB$react))).createElement($fd02a37bc042f4f4$var$LayoutContext.Provider, {
        value: {
            layout: layout,
...
function $fd02a37bc042f4f4$var$CollectionRoot({ collection: collection, persistedKeys: persistedKeys, scrollRef: scrollRef, renderDropIndicator: renderDropIndicator }) {
    let { layout: layout, layoutOptions: layoutOptions } = (0, $68boB$react.useContext)($fd02a37bc042f4f4$var$LayoutContext);
    ...
    let state = (0, $68boB$reactstatelyuseVirtualizerState.useVirtualizerState)({
        ...
        layoutOptions: (0, $68boB$react.useMemo)(()=>{
    ...
    return /*#__PURE__*/ (0, ($parcel$interopDefault($68boB$react))).createElement("div", contentProps, /*#__PURE__*/ (0, ($parcel$interopDefault($68boB$react))).createElement($fd02a37bc042f4f4$var$VirtualizerContext.Provider, {
        value: state
    }, $fd02a37bc042f4f4$var$renderChildren(null, state.visibleViews, renderDropIndicator)));
}
function $fd02a37bc042f4f4$var$CollectionBranch({ parent: parent, renderDropIndicator: renderDropIndicator }) {
    ...
    return $fd02a37bc042f4f4$var$renderChildren(parentView, Array.from(parentView.children), renderDropIndicator);
}
function $fd02a37bc042f4f4$var$renderChildren(parent, children, renderDropIndicator) {
    return children.map((view)=>$fd02a37bc042f4f4$var$renderWrapper(parent, view, renderDropIndicator));
}
function $fd02a37bc042f4f4$var$renderWrapper(parent, reusableView, renderDropIndicator) {
