...
const $1f7d7e07fe5bbfc5$export$28c660c63b792dea = /*#__PURE__*/ (0, $cQApC$react.forwardRef)(function Tooltip({ UNSTABLE_portalContainer: UNSTABLE_portalContainer, ...props }, ref) {
    ...
    let isExiting = (0, $cQApC$reactariaprivateutilsanimation.useExitAnimation)(ref, state.isOpen) || props.isExiting || false;
...
function $1f7d7e07fe5bbfc5$var$TooltipInner(props) {
    ...
    let isEntering = (0, $cQApC$reactariaprivateutilsanimation.useEnterAnimation)(props.tooltipRef, !!placement) || props.isEntering || false;
