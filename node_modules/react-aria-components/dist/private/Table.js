...
const $952ff69934390c62$export$7063e69b8a954175 = /*#__PURE__*/ (0, $7adJ1$forwardRef)(function ResizableTableContainer(props, ref) {
    ...
    let ctx = (0, $7adJ1$useMemo)(()=>({
            ...
            scrollRef: scrollRef,
            tableWidth: width,
            useTableColumnResizeState: $7adJ1$useTableColumnResizeState,
...
const $952ff69934390c62$export$ee689e97a7664bfd = /*#__PURE__*/ (0, $7adJ1$forwardRef)(function ColumnResizer(props, ref) {
    ...
    let { resizerProps: resizerProps, inputProps: inputProps, isResizing: isResizing } = (0, $7adJ1$useTableColumnResize)({
        column: column,
    ...
    let [isMouseDown, setMouseDown] = (0, $7adJ1$useState)(false);
    let onPointerDown = (e)=>{
    ...
    return /*#__PURE__*/ (0, $7adJ1$react).createElement((0, $b7b7a92703138c9b$export$df3a06d6289f983e).div, {
        ref: objectRef,
        role: "presentation",
        ...(0, $7adJ1$mergeProps)(DOMProps, renderProps, resizerProps, {
    ...
    }), isResizing && isMouseDown && /*#__PURE__*/ (0, $7adJ1$reactdom).createPortal(/*#__PURE__*/ (0, $7adJ1$react).createElement("div", {
        style: {
            position: 'fixed',
            top: 0,
            left: 0,
