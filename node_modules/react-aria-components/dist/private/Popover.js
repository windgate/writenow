...
const $03df2f2d3cffb62f$export$5b6b19405a83ff9d = /*#__PURE__*/ (0, $jx81S$forwardRef)(function Popover(props, ref) {
    ...
    let isExiting = (0, $jx81S$useExitAnimation)(ref, state.isOpen) || props.isExiting || false;
...
function $03df2f2d3cffb62f$var$PopoverInner({ state: state, isExiting: isExiting, UNSTABLE_portalContainer: UNSTABLE_portalContainer, clearContexts: clearContexts, ...props }) {
    ...
    let isEntering = (0, $jx81S$useEnterAnimation)(ref, !!placement) || props.isEntering || false;
    ...
    let [isDialog, setDialog] = (0, $jx81S$useState)(false);
    ...
    if (!isSubPopover) return /*#__PURE__*/ (0, $jx81S$react).createElement((0, $jx81S$Overlay), {
        ...props,
