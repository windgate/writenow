...
const $af9b3e5459f1bf61$export$7063e69b8a954175 = /*#__PURE__*/ (0, $ke19Y$react.forwardRef)(function ResizableTableContainer(props, ref) {
    ...
    let ctx = (0, $ke19Y$react.useMemo)(()=>({
            ...
            scrollRef: scrollRef,
            tableWidth: width,
            useTableColumnResizeState: $ke19Y$reactstatelyuseTableState.useTableColumnResizeState,
...
const $af9b3e5459f1bf61$export$ee689e97a7664bfd = /*#__PURE__*/ (0, $ke19Y$react.forwardRef)(function ColumnResizer(props, ref) {
    ...
    }), isResizing && isMouseDown && /*#__PURE__*/ (0, ($parcel$interopDefault($ke19Y$reactdom))).createPortal(/*#__PURE__*/ (0, ($parcel$interopDefault($ke19Y$react))).createElement("div", {
        style: {
            position: 'fixed',
            top: 0,
            left: 0,
