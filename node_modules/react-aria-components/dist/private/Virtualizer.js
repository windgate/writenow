...
const $b75a14d79419a916$var$LayoutContext = /*#__PURE__*/ (0, $83oAu$createContext)(null);
function $b75a14d79419a916$export$89be5a243e59c4b2(props) {
    ...
    return /*#__PURE__*/ (0, $83oAu$react).createElement((0, $a53f0f6636929daa$export$4feb769f8ddf26c5).Provider, {
        value: renderer
    }, /*#__PURE__*/ (0, $83oAu$react).createElement($b75a14d79419a916$var$LayoutContext.Provider, {
        value: {
            layout: layout,
...
function $b75a14d79419a916$var$CollectionRoot({ collection: collection, persistedKeys: persistedKeys, scrollRef: scrollRef, renderDropIndicator: renderDropIndicator }) {
    ...
    let { layout: layout, layoutOptions: layoutOptions } = (0, $83oAu$useContext)($b75a14d79419a916$var$LayoutContext);
    ...
    return /*#__PURE__*/ (0, $83oAu$react).createElement("div", contentProps, /*#__PURE__*/ (0, $83oAu$react).createElement($b75a14d79419a916$var$VirtualizerContext.Provider, {
        value: state
    }, $b75a14d79419a916$var$renderChildren(null, state.visibleViews, renderDropIndicator)));
}
function $b75a14d79419a916$var$CollectionBranch({ parent: parent, renderDropIndicator: renderDropIndicator }) {
    ...
    return $b75a14d79419a916$var$renderChildren(parentView, Array.from(parentView.children), renderDropIndicator);
}
function $b75a14d79419a916$var$renderChildren(parent, children, renderDropIndicator) {
    return children.map((view)=>$b75a14d79419a916$var$renderWrapper(parent, view, renderDropIndicator));
}
function $b75a14d79419a916$var$renderWrapper(parent, reusableView, renderDropIndicator) {
