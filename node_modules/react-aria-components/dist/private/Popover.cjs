...
const $74e35a768d38d46b$export$5b6b19405a83ff9d = /*#__PURE__*/ (0, $kmEDY$react.forwardRef)(function Popover(props, ref) {
    ...
    let isExiting = (0, $kmEDY$reactariaprivateutilsanimation.useExitAnimation)(ref, state.isOpen) || props.isExiting || false;
...
function $74e35a768d38d46b$var$PopoverInner({ state: state, isExiting: isExiting, UNSTABLE_portalContainer: UNSTABLE_portalContainer, clearContexts: clearContexts, ...props }) {
    ...
    let isEntering = (0, $kmEDY$reactariaprivateutilsanimation.useEnterAnimation)(ref, !!placement) || props.isEntering || false;
    ...
    let [isDialog, setDialog] = (0, $kmEDY$react.useState)(false);
    ...
    if (!isSubPopover) return /*#__PURE__*/ (0, ($parcel$interopDefault($kmEDY$react))).createElement((0, $kmEDY$reactariaOverlay.Overlay), {
        ...props,
